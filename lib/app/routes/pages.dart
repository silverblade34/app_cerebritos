...
import 'package:app_cerebritos/app/bindings/examcourse_binding.dart';
...
import 'package:app_cerebritos/app/ui/pages/examcourse/examcourse_page.dart';
...
abstract class AppPages {
  static final pages = [
    ...
    GetPage(
     ...
     GetPage(
      name: Routes.EXAMCOURSE,
      page: () => const ExamCoursePage(),
      binding: ExamCourseBinding()
    )
  ];
}